...
public class TimeSeriesChartExample extends JFrame {  
  ...
  private XYDataset createDataset() {  
    ...
    series3.add(new Day(1, 1, 2017), 44);  
    series3.add(new Day(2, 1, 2017), 36);  
    series3.add(new Day(3, 1, 2017), 23);  
    series3.add(new Day(4, 1, 2017), 42);  
    series3.add(new Day(5, 1, 2017), 47);  
    series3.add(new Day(6, 1, 2017), 38);  
    series3.add(new Day(7, 1, 2017), 48);  
    series3.add(new Day(8, 1, 2017), 41);  
    series3.add(new Day(9, 1, 2017), 36);  
    series3.add(new Day(10, 1, 2017), 82);  
    series3.add(new Day(11, 1, 2017), 29);  
    series3.add(new Day(12, 1, 2017), 37);  
    series3.add(new Day(13, 1, 2017), 15);  
    series3.add(new Day(14, 1, 2017), 24);  
    series3.add(new Day(15, 1, 2017), 12);  
